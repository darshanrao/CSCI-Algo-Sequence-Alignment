...
with open('C:/Users/Shardul/CS570_Algo/Project/problem_size.txt', 'r') as f:
    for line in f.readlines():
        problem_size.append(int(line))
    

for i in range(1,16):
    with open("C:/Users/Shardul/CS570_Algo/Project/outputs_basic/output" + str(i) + ".txt", 'r') as f1:
        data = f1.readlines()
...
for i in range(1,16):
    with open("C:/Users/Shardul/CS570_Algo/Project/outputs_efficient/output" + str(i) + ".txt", 'r') as f2:
        data = f2.readlines()
